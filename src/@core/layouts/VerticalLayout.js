  ...
  return (
    <div
      className={classnames(
        `wrapper vertical-layout w-100 ${navbarWrapperClasses[navbarType]} ${footerClasses[footerType] || 'footer-static'
        }`,
        {
          // Modern Menu
    ...
    >
      ...
      <Navbar
        ...
        className={classnames(
          `header-navbar navbar align-items-center ${navbarClasses[navbarType]} navbar-shadow w-100`
        )}
      >
